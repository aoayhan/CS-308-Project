  ...
  return (
    <div className="header-header">
      <header data-thq="thq-navbar" className="header-navbar-interactive">
        <span className="header-logo">SUpotify</span>
        <div data-thq="thq-navbar-nav" className="header-desktop-menu">
          <nav className="header-links">
            <span className="header-nav1"><a href='home'>Home</a></span>
            <span className="header-nav2"><a href='search'>Search</a></span>
            <span className="header-nav3"><a href='genres'>Genres</a></span>
            <span className="header-nav4"><a href='artists'>Artists</a></span>
            <span className="header-nav5"><a href='Playlists'>Playlists</a></span>
          </nav>
          <div className="header-buttons">
            <button className="header-login button"><a>Login</a></button>
            <button className="header-register button"><a>Register</a></button>
          </div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="header-mobile-menu">
          <div className="header-nav">
            <div className="header-top">
              <span className="header-logo1">SUpotify</span>
            ...
            <nav className="header-links1">
              <span className="header-nav11">Home</span>
              <span className="header-nav21">Search</span>
              <span className="header-nav31">Genres</span>
              <span className="header-nav41">Artists</span>
              <span className="header-nav51">Playlists</span>
            </nav>
